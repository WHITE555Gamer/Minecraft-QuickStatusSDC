...
public class Quick_Recovery implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            if (sender instanceof Player){
                ...
                sender.sendMessage(Quick_Recovery_BaseMsg);
            } else {
            ...
            if (player != null) {
                ...
                if (sender.getName() == player.getName()) {
                    player.sendMessage(Quick_Recovery_BaseMsg);
                } else {
                    sender.sendMessage(Quick_Recovery_BaseMsgFor(player.getName()));
                    player.sendMessage(Quick_Recovery_BaseMsgBy(sender.getName()));
                }
            } else {
